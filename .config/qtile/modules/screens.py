    ...
    Screen(
        top=bar.Bar(
            [   widget.Sep(padding=3, linewidth=0, background=colors[0], foreground=colors[2]),
                widget.Image(filename='~/.config/qtile/icons/python.png', margin=3, background=colors[0], mouse_callbacks={'Button1': lambda: qtile.cmd_spawn("rofi -show combi")}),
