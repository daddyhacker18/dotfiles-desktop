...
#set rsync arguments
rsync_tresorit_options="-avb --backup-dir $tresorit_destination_dir/$current_date --delete"
rsync_home_options="-avb --exclude $exclude_dir --backup-dir $home_destination_dir/$current_date --delete"
